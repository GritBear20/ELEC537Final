...
void experiment (bool enableCtsRts)
{
  ...
  ConstantPositionMobilityModel * APnode = CreateObject<ConstantPositionMobilityModel> ();
  APnode->SetPosition (new Vector(0,0,0));
  ...
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.000000+0.001*i)));
